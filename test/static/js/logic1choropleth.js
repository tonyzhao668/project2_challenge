...
//   legend.addTo(myMap);
 ...
 // }); //original location for d3.json(countriesexpData)

 // Input fields can trigger a change event when update started.
...
d3.json(exportdata, function(data) {
   ...
   //update geodata with enqury year's values
    ...
    updatedgeodata = currentgeodata;
    
//    });

   console.log(updatedgeodata);
   updategeo = L.choropleth(updatedgeodata, {
...
//    });
   ...
   var legend2 = L.control({ position: "bottomright" });
      legend2.onAdd = function() {
        ...
        d3.select("div").selectAll(".update legend").exit().remove();
